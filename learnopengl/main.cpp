...
int main()
{
	...
	Shader lightingShader("../shaders/lighting.vsh", "../shaders/lighting.fsh");
	Shader lampShader("../shaders/lamp.vsh", "../shaders/lamp.fsh");
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(cubeNormalsTexture), cubeNormalsTexture, GL_STATIC_DRAW);
